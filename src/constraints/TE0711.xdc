...
set_property LOC G2 [get_ports TMDS_p[0]]                  #TMDS0_p
set_property IOSTANDARD LVCMOS33 [get_ports {TMDS_p[0]}]

set_property LOC H2 [get_ports TMDS_n[0]]                  #TMDS0_n
set_property IOSTANDARD LVCMOS33 [get_ports {TMDS_n[0]}]


set_property LOC A3 [get_ports TMDS_p[1]]                  #TMDS1_p
set_property IOSTANDARD LVCMOS33 [get_ports {TMDS_p[1]}]

set_property LOC A4 [get_ports TMDS_n[1]]                  #TMDS1_n
set_property IOSTANDARD LVCMOS33 [get_ports {TMDS_n[1]}]


set_property LOC H4 [get_ports TMDS_p[2]]                  #TMDS2_p
set_property IOSTANDARD LVCMOS33 [get_ports {TMDS_p[2]}]

set_property LOC J4 [get_ports TMDS_n[2]]                  #TMDS2_n
